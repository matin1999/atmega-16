...
; 0000 0089 
; 0000 008A 
; 0000 008B /* write hex value for CA display from 0 to 9 */
; 0000 008C         DDRC |= 0xff; /* define LED port direction is output */
	IN   R30,0x14
	ORI  R30,LOW(0xFF)
	OUT  0x14,R30
; 0000 008D           PORTC = 0xff;
	LDI  R30,LOW(255)
	OUT  0x15,R30
; 0000 008E 
; 0000 008F     while(1)
...
_0x8:
	...
	BRGE _0x9
; 0000 0092         {
; 0000 0093             PORTC = array[i]; /* write data on to the LED port */
	LDI  R26,LOW(_array)
	LDI  R27,HIGH(_array)
	ADD  R26,R4
	ADC  R27,R5
	LD   R30,X
	OUT  0x15,R30
; 0000 0094             delay_ms(1000); /* wait for 1 second */
	LDI  R26,LOW(1000)
	LDI  R27,HIGH(1000)
	CALL _delay_ms
; 0000 0095         }
