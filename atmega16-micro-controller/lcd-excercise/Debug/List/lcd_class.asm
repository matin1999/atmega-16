...
_0x0:
	.DB  0x48,0x65,0x6C,0x6C,0x6F,0x0,0x57,0x6F
...
; 0000 008E // RS - PORTA Bit 7
; 0000 008F // RD - PORTA Bit 6
; 0000 0090 // EN - PORTA Bit 5
; 0000 0091 // D4 - PORTA Bit 3
; 0000 0092 // D5 - PORTA Bit 2
; 0000 0093 // D6 - PORTA Bit 1
; 0000 0094 // D7 - PORTA Bit 0
...
; 0000 00A1             lcd_gotoxy(i,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00A2             lcd_puts("Hello");
	__POINTW2MN _0x9,0
	RCALL _lcd_puts
; 0000 00A3             lcd_gotoxy(15-i,1);
	LD   R26,Y
	LDI  R30,LOW(15)
	SUB  R30,R26
	ST   -Y,R30
