...
_0x6:
	.DB  0x6D,0x61,0x74,0x69,0x6E,0x20,0x61,0x6B
	.DB  0x68,0x67,0x61,0x72,0x69,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 008D // RS - PORTA Bit 7
; 0000 008E // RD - PORTA Bit 6
; 0000 008F // EN - PORTA Bit 5
; 0000 0090 // D4 - PORTA Bit 3
; 0000 0091 // D5 - PORTA Bit 2
; 0000 0092 // D6 - PORTA Bit 1
; 0000 0093 // D7 - PORTA Bit 0
; 0000 0094 // Characters/line: 8
...
; 0000 009B       unsigned char names[] = "matin akhgari";
; 0000 009C       int i;
; 0000 009D       int j;
; 0000 009E       for(j=0;j<2;j++)
	SBIW R28,18
	LDI  R24,14
	LDI  R26,LOW(4)
	LDI  R27,HIGH(4)
...
_0xB:
	...
	BRGE _0xC
; 0000 00A1         {
; 0000 00A2             lcd_gotoxy(i,j);
	LDD  R30,Y+2
	ST   -Y,R30
	LDD  R26,Y+1
	RCALL _lcd_gotoxy
; 0000 00A3             lcd_puts(names);
	MOVW R26,R28
	ADIW R26,4
	RCALL _lcd_puts
